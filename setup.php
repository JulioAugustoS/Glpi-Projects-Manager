...
define("PLUGIN_PROJECTS_VERSION", "1.4.4");
...
function plugin_init_projects(){
    ...
    if(isset($_SESSION["glpi_plugin_projects_profile"])) {
        $PLUGIN_HOOKS['menu_toadd']['projects'] = ['tools' => 'PluginProjectsProjects'];
